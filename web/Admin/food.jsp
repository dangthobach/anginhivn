                            ...
                            <div class="table-responsive">
                                ...
                                <c:forEach var="tk" items="<%= new FoodModel().ListFood()%>">
                                    <tr>
                                        ...
                                        <td>
                                            <div align="center">
                                                <a href="${pageContext.request.contextPath}/FoodServlet?foodId=${tk.foodId}&action=xoa" class="btn btn-danger" onclick="return confirm('Are you sure?')"><img src="../Resource/images/delele_food.png" alt="" style="height: 30px"/></a>  
                                                 <a href="${pageContext.request.contextPath}/FoodServlet?foodId=${tk.foodId}&action=chitiet" class="btn btn-danger" onclick="return confirm('Are you sure?')"><img src="../Resource/images/search.png" alt="" style="height: 30px"/></a>
                                ...
                                <a href="addfood.jsp"><input type="button" value="Thêm mới" name="btnThem"></a>
                            </div>
